<?php namespace App\Http\Controllers;
	...
	class AdminEvaluationsMatieresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Evaluations Id','name'=>'evaluations_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'evaluations,nom_evaluation'];
			...
			//$this->form[] = ['label'=>'Evaluations Id','name'=>'evaluations_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'evaluations,nom_evaluation'];
			//$this->form[] = ['label'=>'Matieres Id','name'=>'matieres_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'matieres,code_matiere'];
			//$this->form[] = ['label'=>'Valider','name'=>'valider','type'=>'number','validation'=>'required|min:1|max:1','width'=>'col-sm-10'];
			# OLD END FORM
