<?php namespace App\Http\Controllers;
	...
	class AdminNiveauxController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Code Niveau","name"=>"code_niveau"];
			$this->col[] = ["label"=>"Libelle Niveau","name"=>"libelle_niveau"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Code Niveau","name"=>"code_niveau","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Libelle Niveau","name"=>"libelle_niveau","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
