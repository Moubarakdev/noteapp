<?php namespace App\Http\Controllers;
	...
	class AdminFilieresMatieresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Filieres Id","name"=>"filieres_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"filieres,id"];
			//$this->form[] = ["label"=>"Matieres Id","name"=>"matieres_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"matieres,id"];
			# OLD END FORM
